...
namespace utility {
    namespace vision {
        ...
        template <> struct SpinnakerTypeMap<int>     { using type = Spinnaker::GenApi::CIntegerPtr; };
        template <> struct SpinnakerTypeMap<int64_t> { using type = Spinnaker::GenApi::CIntegerPtr; };
        template <> struct SpinnakerTypeMap<double>  { using type = Spinnaker::GenApi::CFloatPtr;   };

        template <typename T>
        using SpinnakerType = typename SpinnakerTypeMap<T>::type;

        template <typename T>
        inline bool getNumericParam(const Spinnaker::GenApi::INodeMap& nodeMap, const std::string& param, SpinnakerType<T>& value)
        {
        ...
        inline bool getBooleanParam(const Spinnaker::GenApi::INodeMap& nodeMap, const std::string& param, Spinnaker::GenApi::CBooleanPtr& value)
        {
            // Get a pointer to the parameter.
        ...
        inline bool getStringParam(const Spinnaker::GenApi::INodeMap& nodeMap, const std::string& param, Spinnaker::GenApi::CStringPtr& value)
        {
            // Get a pointer to the parameter.
        ...
        inline bool setStringParam(const Spinnaker::GenApi::INodeMap& nodeMap, const std::string& param, const std::string& value)
        {
        ...
        inline bool getEnumParam(const Spinnaker::GenApi::INodeMap& nodeMap, const std::string& param, Spinnaker::GenApi::CEnumerationPtr& value)
        {
            // Get a pointer to the parameter.
        ...
        inline bool getEnumEntry(const Spinnaker::GenApi::CEnumerationPtr& enumName, const std::string& enumEntry, Spinnaker::GenApi::CEnumEntryPtr& value)
        {
            // Get a pointer to the parameter.
        ...
        inline bool setEnumParam(const Spinnaker::GenApi::INodeMap& nodeMap, const std::string& enumName, const std::string& enumEntry)
        {
