...
namespace math {
    namespace optimisation {
        namespace PGA {
             ...
             */
            inline arma::vec updateEstimate(const arma::mat& samples,
                ...
                return arma::sum(samples % arma::repmat(sampleWeights / arma::accu(sampleWeights), 1, samples.n_cols),
                                 0)
                    .t();
            }
             ...
             * @author Josiah walker
             */
            inline arma::mat getSamples(const arma::vec& bestEstimate,
                                        const arma::vec& sigmaWeights,
