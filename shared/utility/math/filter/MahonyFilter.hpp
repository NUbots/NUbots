...
namespace utility {
    namespace math {
        namespace filter {
            ...
            /**
             * @brief The Mahony update uses the IMU data to compute the attitude
             * INPUT
             ...
             * To see report on this, go to "public/Projects/Final Year Projects/NUgus Pose Estimation" folder on the
             * NAS.
             */
            void MahonyUpdate(Eigen::Vector3d acc,
                ...
                // Reference vector for gravity (gravity is positive)
