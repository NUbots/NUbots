...
namespace math {
    namespace filter {
        ...
        public:
            ...
            // Reset function (clears all points out of the circular buffer but does not change its capacity, use
            ...
            void resize(size_t numPoints) {
                // Update the circular buffer capacity (if increasing the size we add zero data points, if decreasing
            ...
            void resize(size_t numPoints, double fillValue) {
                // Update the circular buffer capacity (if increasing the size we add fillValue data points, if
                // decreasing the size we keep the last added data points)
                m_buf.set_capacity(numPoints);
            ...
            void setBuf(Iterator first, Iterator last) {
