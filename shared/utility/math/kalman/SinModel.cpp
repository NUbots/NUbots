...
arma::mat SinModel::processEquation(const arma::mat& state, double deltaT, 
...
arma::mat SinModel::measurementEquation(const arma::mat& state, 
...
arma::mat SinModel::measurementDistance(const arma::mat& measurement1, 
