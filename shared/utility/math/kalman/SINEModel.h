 /*this was the old interface (IKFmodel.h) that SINEModel used to inherit from
...
class IKFModel{ //-------------------------the original interface SINEModel extends from
public:
...
public:
    ...
    SINEModel(); // empty constructor
    SINEModel* Clone() { return new SINEModel(*this); } //this should Ideally be removed and replaced with a smart-pointer equivilant
...
protected:
    SINEModel(const SINEModel& source);
