...
#include "AdaptiveIMUModelQ.h"

namespace utility {
    namespace math {
        namespace kalman {
            arma::vec::fixed<AdaptiveIMUModelQ::size> AdaptiveIMUModelQ::limitState(const arma::vec::fixed<size>& state) {
            ...
            arma::vec::fixed<AdaptiveIMUModelQ::size> AdaptiveIMUModelQ::timeUpdate(const arma::vec::fixed<size>& state, double deltaT, std::nullptr_t) {
                ...
                arma::vec::fixed<AdaptiveIMUModelQ::size> newState;
            ...
            arma::vec AdaptiveIMUModelQ::observationDifference(const arma::vec& a, const arma::vec& b) {
                return a - b;

            }

            arma::mat::fixed<AdaptiveIMUModelQ::size, AdaptiveIMUModelQ::size> AdaptiveIMUModelQ::processNoise() {
