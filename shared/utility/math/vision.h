...
namespace vision {
    ...
    */
    ...
    inline arma::vec2 projectWorldPointToScreen(const arma::vec4& point, const utility::math::Transform& camToGround, const double& camFocalLengthPixels){
        arma::vec4 camSpacePoint = camToGround.i() * point;
        return projectCamSpaceToScreen(camSpacePoint.rows(0,2), camFocalLengthPixels);
    }
    inline arma::vec2 projectWorldPointToScreen(const arma::vec3& point, const utility::math::Transform& camToGround, const double& camFocalLengthPixels){
    ...
    inline arma::vec3 projectCamToPlane(const arma::vec3& cam, const utility::math::Transform& camToGround, const utility::math::geometry::Plane<3>& plane){
    ...
    inline arma::vec3 getGroundPointFromScreen(const arma::vec2& screenPos, const utility::math::Transform& camToGround, const double& camFocalLengthPixels){
