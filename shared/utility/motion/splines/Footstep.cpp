...
namespace utility::motion::splines {
    ...
    Footstep::Footstep(float foot_distance_, bool is_left_support_foot_) {
    ...
    void Footstep::reset(bool is_left_support_foot_) {
        is_left_support_foot = is_left_support_foot_;
    ...
    void Footstep::resetInWorld(bool is_left_support_foot_) {
