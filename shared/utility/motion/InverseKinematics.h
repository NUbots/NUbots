...
namespace kinematics {
    ...
    */
    ...
    std::vector<std::pair<ServoID, float>> setArm(const message::motion::KinematicsModel& model, const Eigen::Vector3d& pos, bool left, int number_of_iterations = 300, Eigen::Vector3d angleHint = Eigen::Vector3d::Zero());
