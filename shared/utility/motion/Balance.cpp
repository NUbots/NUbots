...
namespace motion {
    ...
    void Balancer::balance(const KinematicsModel& model,
        ...
        Transform3D hip = Transform3D(Eigen::Vector3d(model.leg.HIP_OFFSET_X,
        ...
        // Rotation3D yawLessOrientation = Rotation3D::createRotationZ(-Transform3D(sensors.world).rotation()).yaw()) *
