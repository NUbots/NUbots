    ...
    namespace kinematics {
        ...
        */
        inline Eigen::Vector4d calculateCentreOfMass(
            ...
            // Calculate CoM in a very methodical (and verbose) manner
            if (debug) {
                std::pair<Eigen::Vector3d, double> left_leg_com  = {Eigen::Vector3d::Zero(), 0.0};
                std::pair<Eigen::Vector3d, double> right_leg_com = {Eigen::Vector3d::Zero(), 0.0};
                std::pair<Eigen::Vector3d, double> left_arm_com  = {Eigen::Vector3d::Zero(), 0.0};
                std::pair<Eigen::Vector3d, double> right_arm_com = {Eigen::Vector3d::Zero(), 0.0};
                std::pair<Eigen::Vector3d, double> torso_com     = {Eigen::Vector3d::Zero(), 0.0};

                auto print_com = [&Hwt](
                                     const std::string& message, const Eigen::Vector3d& particle, const double& mass) {
                    Eigen::Vector4d p;
                    p << particle.x(), particle.y(), particle.z(), 1.0;
                    NUClear::log<NUClear::INFO>(message, (Hwt * p).head<3>().transpose(), mass);
                };

                left_leg_com.first =
                    (left_leg_com.first * left_leg_com.second + particles[13].first * particles[13].second)
                    / (left_leg_com.second + particles[13].second);
                left_leg_com.second = left_leg_com.second + particles[13].second;
                print_com("Left Foot:", left_leg_com.first, left_leg_com.second);
                left_leg_com.first =
                    (left_leg_com.first * left_leg_com.second + particles[11].first * particles[11].second)
                    / (left_leg_com.second + particles[11].second);
                left_leg_com.second = left_leg_com.second + particles[11].second;
                print_com("Left Ankle:", left_leg_com.first, left_leg_com.second);
                left_leg_com.first =
                    (left_leg_com.first * left_leg_com.second + particles[9].first * particles[9].second)
                    / (left_leg_com.second + particles[9].second);
                left_leg_com.second = left_leg_com.second + particles[9].second;
                print_com("Left Lower Leg:", left_leg_com.first, left_leg_com.second);
                left_leg_com.first =
                    (left_leg_com.first * left_leg_com.second + particles[7].first * particles[7].second)
                    / (left_leg_com.second + particles[7].second);
                left_leg_com.second = left_leg_com.second + particles[7].second;
                print_com("Left Upper Leg:", left_leg_com.first, left_leg_com.second);
                left_leg_com.first =
                    (left_leg_com.first * left_leg_com.second + particles[5].first * particles[5].second)
                    / (left_leg_com.second + particles[5].second);
                left_leg_com.second = left_leg_com.second + particles[5].second;
                print_com("Left Hip:", left_leg_com.first, left_leg_com.second);

                right_leg_com.first =
                    (right_leg_com.first * right_leg_com.second + particles[14].first * particles[14].second)
                    / (right_leg_com.second + particles[14].second);
                right_leg_com.second = right_leg_com.second + particles[14].second;
                print_com("Right Foot:", right_leg_com.first, right_leg_com.second);
                right_leg_com.first =
                    (right_leg_com.first * right_leg_com.second + particles[12].first * particles[12].second)
                    / (right_leg_com.second + particles[12].second);
                right_leg_com.second = right_leg_com.second + particles[12].second;
                print_com("Right Ankle:", right_leg_com.first, right_leg_com.second);
                right_leg_com.first =
                    (right_leg_com.first * right_leg_com.second + particles[10].first * particles[10].second)
                    / (right_leg_com.second + particles[10].second);
                right_leg_com.second = right_leg_com.second + particles[10].second;
                print_com("Right Lower Leg:", right_leg_com.first, right_leg_com.second);
                right_leg_com.first =
                    (right_leg_com.first * right_leg_com.second + particles[8].first * particles[8].second)
                    / (right_leg_com.second + particles[8].second);
                right_leg_com.second = right_leg_com.second + particles[8].second;
                print_com("Right Upper Leg:", right_leg_com.first, right_leg_com.second);
                right_leg_com.first =
                    (right_leg_com.first * right_leg_com.second + particles[6].first * particles[6].second)
                    / (right_leg_com.second + particles[6].second);
                right_leg_com.second = right_leg_com.second + particles[6].second;
                print_com("Right Hip:", right_leg_com.first, right_leg_com.second);

                left_arm_com.first =
                    (left_arm_com.first * left_arm_com.second + particles[3].first * particles[3].second)
                    / (left_arm_com.second + particles[3].second);
                left_arm_com.second = left_arm_com.second + particles[3].second;
                print_com("Left Lower Arm:", left_arm_com.first, left_arm_com.second);
                left_arm_com.first =
                    (left_arm_com.first * left_arm_com.second + particles[1].first * particles[1].second)
                    / (left_arm_com.second + particles[1].second);
                left_arm_com.second = left_arm_com.second + particles[1].second;
                print_com("Left Upper Arm:", left_arm_com.first, left_arm_com.second);

                right_arm_com.first =
                    (right_arm_com.first * right_arm_com.second + particles[4].first * particles[4].second)
                    / (right_arm_com.second + particles[4].second);
                right_arm_com.second = right_arm_com.second + particles[4].second;
                print_com("Right Lower Arm:", right_arm_com.first, right_arm_com.second);
                right_arm_com.first =
                    (right_arm_com.first * right_arm_com.second + particles[2].first * particles[2].second)
                    / (right_arm_com.second + particles[2].second);
                right_arm_com.second = right_arm_com.second + particles[2].second;
                print_com("Right Upper Arm:", right_arm_com.first, right_arm_com.second);

                torso_com.first = (torso_com.first * torso_com.second + left_leg_com.first * left_leg_com.second)
                                  / (torso_com.second + left_leg_com.second);
                torso_com.second = torso_com.second + left_leg_com.second;
                torso_com.first  = (torso_com.first * torso_com.second + right_leg_com.first * right_leg_com.second)
                                  / (torso_com.second + right_leg_com.second);
                torso_com.second = torso_com.second + right_leg_com.second;
                print_com("Both Legs:", torso_com.first, torso_com.second);
                torso_com.first = (torso_com.first * torso_com.second + particles[15].first * particles[15].second)
                                  / (torso_com.second + particles[15].second);
                torso_com.second = torso_com.second + particles[15].second;
                print_com("Torso:", torso_com.first, torso_com.second);
                torso_com.first = (torso_com.first * torso_com.second + left_arm_com.first * left_arm_com.second)
                                  / (torso_com.second + left_arm_com.second);
                torso_com.second = torso_com.second + left_arm_com.second;
                print_com("Torso Left Arm:", torso_com.first, torso_com.second);
                torso_com.first = (torso_com.first * torso_com.second + right_arm_com.first * right_arm_com.second)
                                  / (torso_com.second + right_arm_com.second);
                torso_com.second = torso_com.second + right_arm_com.second;
                print_com("Torso Both Arms:", torso_com.first, torso_com.second);
                torso_com.first = (torso_com.first * torso_com.second + particles[0].first * particles[0].second)
                                  / (torso_com.second + particles[0].second);
                torso_com.second = torso_com.second + particles[0].second;
                print_com("Robot COM:", torso_com.first, torso_com.second);
            }
