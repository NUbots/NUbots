...
namespace learning {
    ...
    public:
        ...
        struct KMeansConfig {
            ...
            bool print_status;  // either true or false; enable or disable printing of progress during the k-means and
                                // EM algorithms
             ...
             * maha_dist        Mahalanobis distance, which uses a global diagonal covariance matrix estimated from the
             * training samples
             *
