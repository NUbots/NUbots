...
namespace utility::slam::measurement {
    ...
    public:
        ...
        virtual Eigen::VectorXd predict(const Eigen::VectorXd& x,
                                        const SystemEstimator& system,
                                        Eigen::MatrixXd& J,
                                        Eigen::Tensor<double, 3>& H) const = 0;
         ...
         */
        virtual gaussian::GaussianInfo<double> predictDensity(const Eigen::VectorXd& x,
    ...
    protected:
         ...
         */
        Eigen::MatrixXd augmentedPredict(const Eigen::VectorXd& xv,
                                         Eigen::MatrixXd& Ja,
                                         const SystemEstimator& system) const;
