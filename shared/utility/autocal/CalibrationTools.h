...
namespace autocal{
	...
	public:
		...
		static std::pair<Eigen::Vector3d,Eigen::Vector3d> getTranslationComponent(const std::vector<utility::math::matrix::Transform3D>& samplesA, const std::vector<utility::math::matrix::Transform3D>& samplesB, const utility::math::matrix::Rotation3D& Ry, bool& success);
