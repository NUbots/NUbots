...
#include "utility/math/filter/BidskiParticleFilter.hpp"
...
TEST_CASE("Test the BidskiParticleFilter", "[utility][math][filter][BidskiParticleFilter]") {

    utility::math::filter::BidskiParticleFilter<double, shared::tests::VanDerPolModel> model_filter;
