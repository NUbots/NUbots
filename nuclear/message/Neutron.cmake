...
foreach(proto ${message_protobufs})
  ...
  add_custom_command(
    OUTPUT ${pb}.pb.cc ${pb}.pb.h ${py}_pb2.py ${dep}.pb.d
    COMMAND ${PROTOBUF_PROTOC_EXECUTABLE} ARGS --cpp_out=lite:${pb_out} --python_out=${py_out}
            --dependency_out=${dep}.pb.d -I${pb_out} -I${builtin_dir} ${pb}.proto
    DEPENDS ${pb}.proto
    DEPFILE ${dep}.pb.d
  ...
  add_custom_command(
    OUTPUT ${nt}.pb
    COMMAND ${PROTOBUF_PROTOC_EXECUTABLE} ARGS --descriptor_set_out=${nt}.pb --dependency_out=${dep}.d
            -I${message_parent_dir} -I${builtin_dir} ${proto}
    DEPENDS ${proto}
    DEPFILE ${dep}.d
