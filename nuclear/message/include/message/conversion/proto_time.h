...
namespace message {
    namespace conversion {
        ...
        ::google::protobuf::Timestamp& convert(::google::protobuf::Timestamp& proto, const std::chrono::time_point<Clock>& t) {
        ...
        template <typename Clock>
        std::chrono::time_point<Clock>& convert(std::chrono::time_point<Clock>& t, const ::google::protobuf::Timestamp& proto) {
        ...
        ::google::protobuf::Duration& convert(::google::protobuf::Duration& proto, const std::chrono::duration<Rep, Period>& d) {
        ...
        template <typename Rep, typename Period>
        std::chrono::duration<Rep, Period>& convert(std::chrono::duration<Rep, Period>& d, const ::google::protobuf::Duration& proto) {
