...
namespace conversion {
    ...
    template <>
    struct ProtobufToVectorMap<::vec2> {
        using type = ::message::conversion::math::vec2;
    };
    template <>
    struct ProtobufToVectorMap<::vec3> {
        using type = ::message::conversion::math::vec3;
    };
    template <>
    struct ProtobufToVectorMap<::vec4> {
        using type = ::message::conversion::math::vec4;
    };
    template <>
    struct ProtobufToVectorMap<::fvec2> {
        using type = ::message::conversion::math::fvec2;
    };
    template <>
    struct ProtobufToVectorMap<::fvec3> {
        using type = ::message::conversion::math::fvec3;
    };
    template <>
    struct ProtobufToVectorMap<::fvec4> {
        using type = ::message::conversion::math::fvec4;
    };
    template <>
    struct ProtobufToVectorMap<::ivec2> {
        using type = ::message::conversion::math::ivec2;
    };
    template <>
    struct ProtobufToVectorMap<::ivec3> {
        using type = ::message::conversion::math::ivec3;
    };
    template <>
    struct ProtobufToVectorMap<::ivec4> {
        using type = ::message::conversion::math::ivec4;
    };
    template <>
    struct ProtobufToVectorMap<::uvec2> {
        using type = ::message::conversion::math::uvec2;
    };
    template <>
    struct ProtobufToVectorMap<::uvec3> {
        using type = ::message::conversion::math::uvec3;
    };
    template <>
    struct ProtobufToVectorMap<::uvec4> {
        using type = ::message::conversion::math::uvec4;
    };
    template <typename T>
    ...
    template <>
    struct DynamicProtobufToVectorMap<::vec> {
        using type = ::message::conversion::math::vec;
    };
    template <>
    struct DynamicProtobufToVectorMap<::fvec> {
        using type = ::message::conversion::math::fvec;
    };
    template <>
    struct DynamicProtobufToVectorMap<::ivec> {
        using type = ::message::conversion::math::ivec;
    };
    template <>
    struct DynamicProtobufToVectorMap<::uvec> {
        using type = ::message::conversion::math::uvec;
    };
    template <typename T>
    ...
    template <>
    struct VectorToProtobufMap<::message::conversion::math::vec2> {
        using type = ::vec2;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::vec3> {
        using type = ::vec3;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::vec4> {
        using type = ::vec4;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::fvec2> {
        using type = ::fvec2;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::fvec3> {
        using type = ::fvec3;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::fvec4> {
        using type = ::fvec4;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::ivec2> {
        using type = ::ivec2;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::ivec3> {
        using type = ::ivec3;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::ivec4> {
        using type = ::ivec4;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::uvec2> {
        using type = ::uvec2;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::uvec3> {
        using type = ::uvec3;
    };
    template <>
    struct VectorToProtobufMap<::message::conversion::math::uvec4> {
        using type = ::uvec4;
    };
    template <typename T>
    ...
    template <>
    struct DynamicVectorToProtobufMap<::message::conversion::math::vec> {
        using type = ::vec;
    };
    template <>
    struct DynamicVectorToProtobufMap<::message::conversion::math::fvec> {
        using type = ::fvec;
    };
    template <>
    struct DynamicVectorToProtobufMap<::message::conversion::math::ivec> {
        using type = ::ivec;
    };
    template <>
    struct DynamicVectorToProtobufMap<::message::conversion::math::uvec> {
        using type = ::uvec;
    };
    template <typename T>
    ...
    template <>
    struct ProtobufToMatrixMap<::mat22> {
        using type = ::message::conversion::math::mat22;
    };
    template <>
    struct ProtobufToMatrixMap<::mat33> {
        using type = ::message::conversion::math::mat33;
    };
    template <>
    struct ProtobufToMatrixMap<::mat44> {
        using type = ::message::conversion::math::mat44;
    };
    template <>
    struct ProtobufToMatrixMap<::fmat22> {
        using type = ::message::conversion::math::fmat22;
    };
    template <>
    struct ProtobufToMatrixMap<::fmat33> {
        using type = ::message::conversion::math::fmat33;
    };
    template <>
    struct ProtobufToMatrixMap<::fmat44> {
        using type = ::message::conversion::math::fmat44;
    };
    template <>
    struct ProtobufToMatrixMap<::imat22> {
        using type = ::message::conversion::math::imat22;
    };
    template <>
    struct ProtobufToMatrixMap<::imat33> {
        using type = ::message::conversion::math::imat33;
    };
    template <>
    struct ProtobufToMatrixMap<::imat44> {
        using type = ::message::conversion::math::imat44;
    };
    template <>
    struct ProtobufToMatrixMap<::umat22> {
        using type = ::message::conversion::math::umat22;
    };
    template <>
    struct ProtobufToMatrixMap<::umat33> {
        using type = ::message::conversion::math::umat33;
    };
    template <>
    struct ProtobufToMatrixMap<::umat44> {
        using type = ::message::conversion::math::umat44;
    };
    template <typename T>
    ...
    template <>
    struct DynamicProtobufToMatrixMap<::mat> {
        using type = ::message::conversion::math::mat;
    };
    template <>
    struct DynamicProtobufToMatrixMap<::fmat> {
        using type = ::message::conversion::math::fmat;
    };
    template <>
    struct DynamicProtobufToMatrixMap<::imat> {
        using type = ::message::conversion::math::imat;
    };
    template <>
    struct DynamicProtobufToMatrixMap<::umat> {
        using type = ::message::conversion::math::umat;
    };
    template <typename T>
    ...
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::mat22> {
        using type = ::mat22;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::mat33> {
        using type = ::mat33;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::mat44> {
        using type = ::mat44;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::fmat22> {
        using type = ::fmat22;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::fmat33> {
        using type = ::fmat33;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::fmat44> {
        using type = ::fmat44;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::imat22> {
        using type = ::imat22;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::imat33> {
        using type = ::imat33;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::imat44> {
        using type = ::imat44;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::umat22> {
        using type = ::umat22;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::umat33> {
        using type = ::umat33;
    };
    template <>
    struct MatrixToProtobufMap<::message::conversion::math::umat44> {
        using type = ::umat44;
    };
    template <typename T>
    ...
    template <>
    struct DynamicMatrixToProtobufMap<::message::conversion::math::mat> {
        using type = ::mat;
    };
    template <>
    struct DynamicMatrixToProtobufMap<::message::conversion::math::fmat> {
        using type = ::fmat;
    };
    template <>
    struct DynamicMatrixToProtobufMap<::message::conversion::math::imat> {
        using type = ::imat;
    };
    template <>
    struct DynamicMatrixToProtobufMap<::message::conversion::math::umat> {
        using type = ::umat;
    };
    template <typename T>
