...
FUNCTION(NUCLEAR_MODULE)
    ...
    ELSEIF(MODULE_LANGUAGE STREQUAL "PYTHON")
        ...
        SET(ENV{NUCLEAR_MODULE_DIR} "${PROJECT_SOURCE_DIR}/${NUCLEAR_MODULE_DIR}")
        ...
        ADD_CUSTOM_COMMAND(
            ...
            ARGS -E env
                PYTHONPATH="${PROJECT_BINARY_DIR}/python/nuclear:${PYTHONPATH}:${PYTHON_SITE_PACKAGES}"
                NUCLEAR_MODULE_DIR="${PROJECT_SOURCE_DIR}/${NUCLEAR_MODULE_DIR}"
                LD_LIBRARY_PATH="/nubots/toolchain/${PLATFORM}/lib:/nubots/toolchain/lib"
        ...
        ADD_CUSTOM_COMMAND(OUTPUT "${PROJECT_BINARY_DIR}/python/nuclear/nuclear.py"
    ...
    # Commits the list of data files needed/generated by all modules to the cache
    SET(NUCLEAR_MODULE_DATA_FILES "${NUCLEAR_MODULE_DATA_FILES}" CACHE INTERNAL
        "A list of all the data files that were generated by modules" FORCE
    )
