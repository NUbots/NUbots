...
\begin{document}
    ...
    \section{Overview}
        ...
        \subsection{Existing Architecture} 
            ...
            When viewed from far away the existing architecture often resembles an intricate spider web
            woven from good intentions and software engineer nightmares. Originally it was built as
