...
\begin{document}
	...
	\section{Overview}
		...
		\subsection{Proposed Architecture}
			...
			For example: A reaction that is called when new image data is retrieved. \emph{Emit} allows \gls{reactor}s to send out a new
			piece of data such as the sensor \gls{reactor} using \emph{Emit} to send new image data every
			time it reads the camera hardware. \gls{reactor}s also provide one special type of event named
			...
			The proposed architecture allows you to treat \gls{reactor}s on other robots as potential
	...
	\section{Scenarios}
		...
		\subsection{New Functionality Added to System}
			...
			\subsubsection{Proposed System}
				...
				in as part of the standard communication api. Instead we modify the motion \gls{reactor} to handle the new type of movement.
