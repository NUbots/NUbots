    ...
    \section{Overview}
        ...
        \subsection{Proposed Architecture}
            ...
            \begin{figure}[b]
                ...
                \begin{tikzpicture}[task/.style={rectangle,draw,anchor=west}]
                    
                    % Show 3 cycles of the system
                    ...
                    % Tasks Iteration
                    \node[task,minimum width=5em] at (3em ,2) {C};
                    \node[task,minimum width=4em] at (3em ,1) {S};
                    \node[task,minimum width=3em] at (7em ,0) {O};
                    \node[task,minimum width=7em] at (8em ,1) {V};
                    \node[task,minimum width=3em] at (15em,2) {L};
                    \node[task,minimum width=2em] at (18em,0) {B};
                    \node[task,minimum width=2em] at (20em,1) {M};
                    
                    % Emission Lines
                    
                    
                    
                    % Add nodes to represent tasks with the correct width
