...
\begin{document}
    ...
    \section{Overview}
        ...
        \subsection{Existing Architecture} 
            ...
            the architecture has heavily impacted the architecture quality.
           ...
           that needs to talk to more then five other components. 
           That's a minimum of six different systems you need to understand before you can make even the smallest of changes.
