...
\begin{document}
    ...
    \section{Scenarios}
        ...
        \subsection{Debugging When Bug is Found}
            \todo[inline]{Write the scenario for a bug occurring}
    ...
    \section{Overview}
        ...
        \subsection{Existing Architecture} 
            ...
            For example: The vision system communicates utilising a two step process. First the vision system requests that the sensors retrieve a new frame. It then waits
