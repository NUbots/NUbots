...
\begin{document}
	...
	\section{Scenarios}
		...
		\subsection{New Functionality Added to System}
			...
			\subsubsection{Current System} %TODO
				...
				\end{itemize} %TODO is this right, particuarly script and behaviour?
			\subsubsection{Proposed System}
				In order to implement this in the proposed system, the following changes would be required
				\begin{itemize}
					\item The script system would need to modified to include many dance scripts.
...
analyser stage, the last several snippets of recordings will be combined, ready for analyis. The
recording must use the Darwin robot’s microphone.
				This is feature, is neccessary for the requirement of dancing according to music.
...
ignore the first musical item, and only calculate the beat on the audio of the second musical item.
				...
				The beat tracker must emit the location of the beat within 50ms after the beat occured.
