...
\usepackage{etex} 	%Includes this to prevent an error from having 'too many things'. Latex apparently is terrible at memory 						%management by default.  See http://www.tex.ac.uk/cgi-bin/texfaq2html?label=noroom
