	...
	\begin{itemize}
		\item Hidden Dependencies
			\begin{itemize}
				...
				\item These hidden dependencies make it difficult to work on a system without understanding the whole ssytem
			\end{itemize}
	...
	\begin{itemize}			
		\item Network Communication
			\begin{itemize}
				...
				\item Because of the difficult of adding new networking, no new networking will be added
			\end{itemize}
...
\subsection{C++ Smart Pointers and Templates Recap}
\begin{frame}
	\frametitle{Smart Pointers}
	\begin{itemize}
		\item Smart Pointers automatically handle releasing pointer memory for you.
		\item Different Smart Pointers mean different things regarding memory ownership (who is responsible for deleting this pointer).
		\item As of C++11 there is almost never a reason to use new/delete or raw pointers.
		\item Instead you should use std::unique\_ptr and std::shared\_ptr
