...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Templates let you provide a "blueprint" for a function or class allowing you to generate
			copies of the same class that vary based on what types they take. 
