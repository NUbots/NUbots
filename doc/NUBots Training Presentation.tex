...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item The major benifit is you can see logs on a per-reaction basis.
		\item If you use std::cout/std::clog you'll get garbled output (thansk threading!)
		\item Luckily log is easy to use! It supports anything that std::cout can stream.
