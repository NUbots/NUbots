...
\begin{frame}[fragile]
	\frametitle{Auto}
	\begin{itemize}
		\item C++11 repurposed auto to do automatic type deduction.
	...
	\begin{lstlisting}[language=nuclear]
		int main() {
		    std::vector<int> vecr = {1,2,3,4,5};

		    // No more std::vector<int>::iterator!
		    ...
		    // Normally you'd need to type std::map<std::complex, SomeLongTemplateType<int>>
