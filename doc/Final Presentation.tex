...
\begin{frame}
	...
	\begin{itemize}
		\item Coupling levels, from most coupled to least coupled are as follows
		\begin{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item Message coupling is the lest coupled method of communication
		\item As such a system built on message passing systems have excellent maintainability and modifiability
		\item This is due to the systems requiring no knowledge of eachother
	\end{itemize}
\end{frame}
...
% replaces the blackboard style datastore implicitly
% components are no longer linked to their datastore
