	...
	\begin{frame} 
		...
		\begin{figure}
			...
			\begin{tikzpicture}[
				...
				%%% Draw all of our components in a circle
				\foreach [count=\i] \reactor/\style in {{Camera/same}, {Vision/same}, {Localisation/same}, {Behavior/modified}, {Network/same}, {Sensors/same}, {Kinematics/same}, {Motion/modified}, {Actionators/same}, {AudioInput/new}, {BeatTracker/new}} {
