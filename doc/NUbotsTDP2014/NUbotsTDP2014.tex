...
\tocauthor{B. Annable, A. Biddulph, S.K. Chalup, J. Fountain, R.A.R. King, A. Mendes, M. Metcalfe, P. Turner, J. Walker, T. Johnson, J. Johnson, A. Sugo, A. Dabson, T. Houliston}
%
...
\item \emph{Alex Biddulph} is a 4th year undergraduate student studying Computer Engineering and Computer Science. His final year project is to improve the vision system and develop an alternative controller platform for the Darwin. %e is working on improving the vision system and replacing the CM730.
