...
\section{Modules}
	...
	\subsection{LinuxCameraStreamer}
		...
		\subsubsection{Tests}
			...
			\begin{enumerate}
				\item Use the NUBugger module to manually verify incoming image data.
			\end{enumerate}
			
			\test{The LinuxCameraStreamer will respond and update settings on the camera when needed.}
			\begin{enumerate}
				\item Change and save the camera configuration file.
				\item Validate that the changes were applied.
			\end{enumerate}
	...
	\subsection{NUBugger}
		...
		\subsubsection{Tests}
			...
			\begin{enumerate}
				\item Run the robot and NUBugger binaries.
				\item Manually ensure data is sent and visualized properly.
			\end{enumerate}
