	...
	\section{NUClear Powered NUbots}
		...
		\subsection{Modules}
			...
			\subsubsection{BeatDetector}
				This module finds the beat of music as it plays using an algorithm based on
			...
			\subsubsection{DarwinHardwareIO}
				...
				the colour of the LEDs in the Darwin's head or eyes, respectively. When it
				receives a \texttt{DarwinServoCommand} (or a sequence of them in a
			...
			\subsubsection{DarwinMotionManager}
				...
				\texttt{ServoWaypointsCompleted<ServoID>} message is
				...
				been completed an \texttt{AllServoWaypointsComplete} message is also emitted.
