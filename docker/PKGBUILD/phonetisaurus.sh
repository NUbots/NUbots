...
license=('BSD')
depends=('python') # 'openfst' is installed manually and not checked here because it would cause the dependency check to fail.
makedepends=('python-setuptools' 'git') # 'python-pybindgen' is installed manually but not listed similarly.
