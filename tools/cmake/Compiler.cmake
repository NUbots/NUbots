...
SET(CMAKE_CXX_FLAGS_LTO            "-O3 -fuse-linker-plugin -ffast-math -flto=jobserver -fno-fat-lto-objects ${CMAKE_CXX_FLAGS_LTO} ${COMMON_CXX_FLAGS}")
SET(CMAKE_C_FLAGS_LTO              "-O3 -fuse-linker-plugin -ffast-math -flto=jobserver -fno-fat-lto-objects ${CMAKE_C_FLAGS_LTO} ${COMMON_C_FLAGS}")
