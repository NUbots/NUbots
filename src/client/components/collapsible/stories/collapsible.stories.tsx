...
storiesOf('components.collapsible', module)
  ...
  .add('basic', () => {
    return <Collapsible open={true} onToggle={actions.onToggle}>
  ...
  .add('with header', () => {
    ...
    return <Collapsible open={true} onToggle={actions.onToggle} header={header}>
      <div>Collapsible content</div>
      <div>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis quam, beatae ut ipsum,
        tenetur eveniet. Adipisci sed, labore eos molestias.
  ...
  .add('interactive', () => {
    ...
    const Component = observer(() => <div>
      <label><input type='checkbox' checked={model.animate} onChange={onCheckboxChange}/> Animate</label>
