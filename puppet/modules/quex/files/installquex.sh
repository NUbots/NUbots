#!/bin/bash
cd /var/tmp
wget https://downloads.sourceforge.net/project/quex/DOWNLOAD/quex-0.65.1c.tar.gz -O quex-0.65.1c.tar.gz
tar -zxf quex-0.65.1c.tar.gz
mv quex-0.65.1c/ /usr/local/etc/quex
