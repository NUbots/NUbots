...
node nubotsvm {
  ...
  exec { 'download_catchhpp':
                                command => 'wget https://raw.githubusercontent.com/philsquared/Catch/master/single_include/catch.hpp',
  ...
  installer { 'nuclear':        url => 'https://github.com/Fastcode/NUClear/archive/OldDSL.tar.gz',
                                ...
                                require => [ Installer['zeromq'], Installer['protobuf'], Exec['download_zmqhpp'] ], }
