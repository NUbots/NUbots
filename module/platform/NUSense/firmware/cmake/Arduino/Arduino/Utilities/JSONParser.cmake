...
function(json_parse json_content namespace)
  ...
  string(REGEX MATCHALL "\"(\\\\.|[^\"])*\"|[][{}:,]|true|false|null|-?[0-9]+(\\.[0-9]*)?([eE][+-]?[0-9]+)?" token_list
               "${json_content}"
  )
  ...
  foreach(var ${token_list})
    ...
    elseif(${json_parse_state} STREQUAL "NAME1" OR ${json_parse_state} STREQUAL "NAME2")

      if(${json_parse_state} STREQUAL "NAME1" AND var STREQUAL "}")
