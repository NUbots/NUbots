...
set(ARDUINO_CMAKE_HEADER_FILES_SUFFIX_REGEX
    "(\\.[hH]|\\.[hH][hH]|\\.[hH][pP][pP]|\\.[hH][xX][xX])"
    CACHE STRING "Header Files suffix used for regular expression"
)
set(ARDUINO_CMAKE_HEADER_INCLUDE_REGEX_PATTERN
    "^[ \t]*#[ \t]*include[ \t]*[<\"]"
    CACHE STRING "Regex pattern matching header inclusion in a source file"
)
set(ARDUINO_CMAKE_HEADER_NAME_REGEX_PATTERN
    "${ARDUINO_CMAKE_HEADER_INCLUDE_REGEX_PATTERN}(.+)${ARDUINO_CMAKE_HEADER_FILES_SUFFIX_REGEX}[>\"]$"
    CACHE STRING "Regex pattern matching a header's name when wrapped in inclusion line"
)
