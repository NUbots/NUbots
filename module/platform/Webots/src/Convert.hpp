...
#ifndef MODULES_PLATFORM_WEBOTS_CONVERT_HPP
#define MODULES_PLATFORM_WEBOTS_CONVERT_HPP
...
namespace module::platform::webots {
    ...
    struct Convert {
        ...
        /// The value from the webots is between -39.24 and 39.240, representing a value between -4g and 4g.
        /// This means 0 = 0
        static constexpr double ACCELEROMETER_CONVERSION_FACTOR = (4 * 9.80665) / 60.76;

        /// The Gyrosocope value from the webots is between 0 and 1023, representing a value between -500 and
        ...
        /// periodically
        static constexpr double GYROSCOPE_CONVERSION_FACTOR = (1880.0 * (M_PI / 180.0)) / 8.762;

        /// The value that comes from the webots is measured in decivolts (0.1 of a volt)
        static constexpr double VOLTAGE_CONVERSION_FACTOR = 0.1;

        /// The FSR values that are measured by the webotss feet are measured in millinewtons
