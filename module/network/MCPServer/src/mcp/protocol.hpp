...
namespace mcp {
    ...
    struct JsonRpcResponse {
        ...
        std::variant<nlohmann::json /*result*/, ErrorObject /*error*/> outcome;
    ...
    using JsonRpcMessage = std::variant<JsonRpcRequest, JsonRpcNotification, JsonRpcResponse>;
    ...
    inline constexpr std::string_view method_notifications_initialized = "notifications/initialized";
    ...
    using PlainContentBlock = std::variant<TextContent, ImageContent, AudioContent, ResourceLink, EmbeddedResource>;
    ...
    inline constexpr std::string_view method_notifications_resources_updated = "notifications/resources/updated";
    ...
    inline constexpr std::string_view method_notifications_prompts_list_changed = "notifications/prompts/list_changed";
    ...
    inline constexpr std::string_view method_notifications_cancelled = "notifications/cancelled";
    ...
    inline constexpr std::string_view method_notifications_progress = "notifications/progress";
    ...
    inline constexpr std::string_view method_sampling_create_message = "sampling/createMessage";
    ...
    inline constexpr std::string_view method_notifications_roots_list_changed = "notifications/roots/list_changed";
    ...
    using ElicitRequestParams = std::variant<ElicitFormRequestParams, ElicitUrlRequestParams>;
    ...
    inline constexpr std::string_view method_elicitation_create                 = "elicitation/create";
    inline constexpr std::string_view method_notifications_elicitation_complete = "notifications/elicitation/complete";
    ...
    inline constexpr std::string_view method_notifications_tasks_status = "notifications/tasks/status";
    ...
    /// optionally check it.
    inline constexpr std::string_view tasks_related_task_meta_key = "io.modelcontextprotocol/related-task";
