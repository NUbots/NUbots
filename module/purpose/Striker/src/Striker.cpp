...
namespace module::purpose {
    ...
    void Striker::play() {
        ...
        // emit<Task>(std::make_unique<FindBall>(), 1);    // if the look/walk to ball tasks are not running, find the
        // ball
        ...
        emit<Task>(std::make_unique<KickTo>(), 5);  // kick the ball if possible
    }
