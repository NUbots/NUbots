...
namespace localisation {
    ...
    public:
        ...
        RobotHypothesis(const message::localisation::ResetRobotHypotheses::Self& reset_self,
            ...
            arma::vec::fixed<robot::RobotModel::size> mean =
                arma::vec::fixed<robot::RobotModel::size>({reset_self.position(0), reset_self.position(1), imuOffset});
            arma::mat::fixed<robot::RobotModel::size, robot::RobotModel::size> cov =
                arma::eye(robot::RobotModel::size, robot::RobotModel::size) * 0.1;
