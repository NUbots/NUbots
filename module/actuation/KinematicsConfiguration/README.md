...
Populates a `KinematicsModel` message and `ServoOffsets` message using values in the configuration files for the rest of the system to use throughout the program. Only emits once at the start.
