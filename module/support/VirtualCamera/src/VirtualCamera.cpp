    ...
    VirtualCamera::VirtualCamera(std::unique_ptr<NUClear::Environment> environment)
        ...
        emitImageHandle = on<Every<30, Per<std::chrono::seconds>>, With<CameraParameters>, Single>().then(
            "Simulated Images (VCamera)", [this](const CameraParameters& cam) {
                ...
                // msg->Hcw(3, 2)     = 0.92;
                msg->Hcw(0, 0) = 0.8768785689246595;
                msg->Hcw(0, 1) = 0.4291316712922149;
                msg->Hcw(0, 2) = -0.21663329396607428;
                msg->Hcw(0, 3) = 0.10239133982361005;
                msg->Hcw(1, 0) = -0.44431860612370105;
                msg->Hcw(1, 1) = 0.8955332256457459;
                msg->Hcw(1, 2) = -0.024519747486806718;
                msg->Hcw(1, 3) = 0.038385483493038594;
                msg->Hcw(2, 0) = 0.1834801123090251;
                msg->Hcw(2, 1) = 0.1177550443016172;
                msg->Hcw(2, 2) = 0.975945079360817;
                msg->Hcw(2, 3) = -0.7553306500891327;
                msg->Hcw(3, 0) = 0.0;
                msg->Hcw(3, 1) = 0.0;
                msg->Hcw(3, 2) = 0.0;
                msg->Hcw(3, 3) = 1.0;
