...
namespace motion {
    ...
    WalkEngine::WalkEngine(std::unique_ptr<NUClear::Environment> environment)
        ...
        , uTorso(arma::fill::zeros), uTorsoSource(arma::fill::zeros), uTorsoDestination(arma::fill::zeros)
        , uLeftFoot(arma::fill::zeros), uLeftFootSource(arma::fill::zeros), uLeftFootDestination(arma::fill::zeros)
        , uRightFoot(arma::fill::zeros), uRightFootSource(arma::fill::zeros), uRightFootDestination(arma::fill::zeros)
        , uSupport(arma::fill::zeros), velocityCurrent(arma::fill::zeros), velocityCommand(arma::fill::zeros)
        , velocityDifference(arma::fill::zeros), zmpCoefficients(arma::fill::zeros), zmpParams(arma::fill::zeros)
        ...
        , footOffset(arma::fill::zeros), uLRFootOffset(arma::fill::zeros), qLArmStart(arma::fill::zeros)
