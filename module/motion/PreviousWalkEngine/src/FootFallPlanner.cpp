...
namespace motion {
    ...
    void PreviousWalkEngine::calculateNewStep() {
        updateVelocity();
    ...
    void PreviousWalkEngine::updateVelocity() {
    ...
    Transform2D PreviousWalkEngine::getNewFootTarget(const Transform2D& velocity, const Transform2D& leftFoot, const Transform2D& rightFoot, const LimbID& swingLeg) {
    ...
    arma::vec3 PreviousWalkEngine::footPhase(double phase, double phase1Single, double phase2Single) {
