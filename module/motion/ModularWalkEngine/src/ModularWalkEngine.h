...
namespace motion 
{
    ...
    public:
        ...
        static constexpr const char* CONFIGURATION_MSSG = "Modular Walk Engine - Configure";
        static constexpr const char* ONTRIGGER_FTMN_INF = "Modular Walk Engine - Received update (Balanced Foot Position) Info";
        static constexpr const char* ONTRIGGER_TRSM_INF = "Modular Walk Engine - Received update (Balanced Torso Position) Info";
        static constexpr const char* ONTRIGGER_HEAD_INF = "Modular Walk Engine - Received update (Balanced Head Position) Info";
