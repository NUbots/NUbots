...
namespace module {
    namespace motion {
        ...
        public:
            ...
            void start(const message::motion::KinematicsModel& kinematicsModel,
            ...
            Eigen::Affine3d getFootPose(const message::input::Sensors& sensors) {
                ...
                if (stage == MotionStage::RUNNING || stage == MotionStage::STOPPING) {
                    ...
                    double elapsedTime =
                        std::chrono::duration_cast<std::chrono::microseconds>(sensors.timestamp - motionStartTime)
                            .count()
                        * 1e-6;
                    ...
                    for (int id = utility::input::ServoID::R_HIP_YAW; id <= utility::input::ServoID::L_ANKLE_ROLL;
                         ++id) {
