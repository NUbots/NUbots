...
public:
    ...
    //! Shift the CoM position estimate by a given increment, leaving the velocity untouched (refer to
    //! `GolayFilter::shiftPosBy`)
    ...
    //! Shift the CoM position estimate to a given value, leaving the velocity untouched (refer to
    //! `GolayFilter::shiftPosTo`)
