...
namespace contrib {
    ...
    double Limp::vx(double x) {
        ...
        if (x0 == 0 and v0 == 0 and x != 0) return sqrt(-1);  // NaN
        ...
        if (v0 * v0 - C * x0 * x0 <= 0 and x0 * x < 0) return sqrt(-1);  // NaN
        ...
        if (v0 * v0 - C * x0 * x0 > 0) return (v0 > 0 ? 1.0 : -1.0) * sqrt(v0 * v0 + C * (x * x - x0 * x0));
    ...
    double Limp::x(double vx) {
        ...
        if (v0 * v0 - C * x0 * x0 > 0) return (x0 > 0 ? 1.0 : -1.0) * sqrt(x0 * x0 + (vx * vx - v0 * v0) / C);
    ...
    double Limp::origin(double x, double vx) {
        ...
        return x == 0 ? utility::math::sign0(v0) * x00 : utility::math::sign(x) * x00;
    }
