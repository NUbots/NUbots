...
namespace pose {
    ...
    struct JointLegPose {
        ...
        //! Set the joint pose in mirror mode (directly set the joint pose parameters if this is the left leg, or mirror
    ...
    struct JointArmPose {
        ...
        //! Set the joint pose in mirror mode (directly set the joint pose parameters if this is the left arm, or mirror
        ...
        //! Blend this joint pose towards another one by a given blending factor (@p b: 0 = Pose remains unchanged, 1 =
        //! Pose becomes @p other, (0,1) = Blending by linear interpolation between `this` and @p other)
