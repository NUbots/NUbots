...
namespace util {
     ...
     *
     * @brief Data struct that contains the information pertaining to a leg pose that should be common amongst all pose
     *representations.
     *
     * The assumed joint order is `hip yaw` &rarr; `hip roll` &rarr; `hip pitch` &rarr; `knee pitch` &rarr; `ankle
     *pitch` &rarr; `ankle roll`. The upper and lower leg links are assumed to be of the same length (i.e. #linkLength).
     **/
    struct CommonLegData {
        //
        // Constructor
        ...
        //! Default constructor
        explicit CommonLegData(bool left = true) {
            reset(left);
        }
        ...
        inline void setEffort(double effHipYaw,
                              double effHipRoll,
                              double effHipPitch,
                              double effKneePitch,
        ...
        // Joint efforts
        //! Dimensionless effort value associated with the hip yaw (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortHipYaw;
        //! Dimensionless effort value associated with the hip roll (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortHipRoll;
        //! Dimensionless effort value associated with the hip pitch (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortHipPitch;
        //! Dimensionless effort value associated with the knee pitch (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortKneePitch;
        //! Dimensionless effort value associated with the ankle pitch (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortAnklePitch;
        //! Dimensionless effort value associated with the ankle roll (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortAnkleRoll;

        // Support coefficient
        //! Dimensionless support coefficient representing how much of the robot's weight is on this leg (in the range
        //! `[0,1]`, 0 = No support, 1 = Full support)
        double supportCoeff;
     ...
     *
     * @brief Data struct that contains the information pertaining to an arm pose that should be common amongst all pose
     *representations.
     *
     * The assumed joint order is `shoulder pitch` &rarr; `shoulder roll` &rarr; `elbow pitch`. The upper and lower arm
     *links are assumed to be of the same length (i.e. #linkLength).
     **/
    struct CommonArmData {
        //
        // Constructor
        ...
        //! Default constructor
        explicit CommonArmData(bool left = true) {
            reset(left);
        }
        ...
        // Joint efforts
        //! Dimensionless effort value associated with the shoulder pitch (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortShoulderPitch;
        //! Dimensionless effort value associated with the shoulder roll (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
        double effortShoulderRoll;
        //! Dimensionless effort value associated with the elbow pitch (in the range `[0,1]`, 0 = No effort, 1 = Full
        //! effort)
