...
struct JointLegPose {
    ...
    //! Default constructor
    explicit JointLegPose(bool left = true) {
        reset(left);
    }
    ...
    inline void setPose(double hipYaw,
                        double hipRoll,
                        double hipPitch,
                        double kneePitch,
                        double anklePitch,
    ...
    //! Set the joint pose in mirror mode (directly set the joint pose parameters if this is the left leg, or mirror the
    //! pose if this is the right leg)
    inline void setPoseMirrored(double hipYaw,
                                double hipRoll,
                                double hipPitch,
                                double kneePitch,
                                double anklePitch,
    ...
    inline void fromJointAngles(double hipYaw,
                                double hipRoll,
                                double hipPitch,
                                double kneePitch,
                                double anklePitch,
    ...
    inline void getJointAngles(double& hipYaw,
                               double& hipRoll,
                               double& hipPitch,
                               double& kneePitch,
                               double& anklePitch,
    ...
    //! Blend this joint pose towards another one by a given blending factor (@p b: 0 = Pose remains unchanged,
    //! 1 = Pose becomes @p other, (0,1) = Blending by linear interpolation between `this` and @p other)
...
struct JointArmPose {
    ...
    //! Default constructor
    explicit JointArmPose(bool left = true) {
        reset(left);
    }
    ...
    //! Set the joint pose in mirror mode (directly set the joint pose parameters if this is the left arm, or mirror the
    //! pose if this is the right arm)
    ...
    //! Blend this joint pose towards another one by a given blending factor (@p b: 0 = Pose remains unchanged, 1 = Pose
    //! becomes @p other, (0,1) = Blending by linear interpolation between `this` and @p other)
