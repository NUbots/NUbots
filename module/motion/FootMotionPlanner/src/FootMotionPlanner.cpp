...
/*=======================================================================================================*/
        ...
        , kinematicsModel()
    {
        ...
        .then("Foot Motion Planner - Update Foot Position", [this]
        {
                ...
                //emit(graph("FMP Synchronising Motion Phase", Eigen::Vector2d(motionPhase, (getActiveForwardLimb() == LimbID::LEFT_LEG ? 1  : 0))));
        }).disable();
...
/*=======================================================================================================*/
    void FootMotionPlanner::configure(const YAML::Node& config)
    {
        ...
        setFootOffsetCoefficient(stance["foot_offset"].as<Expression>());
