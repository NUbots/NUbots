#ifndef MODULE_INPUT_IMAGEDECOMPRESSOR_H
#define MODULE_INPUT_IMAGEDECOMPRESSOR_H
...
#include "decompressor/DecompressorFactory.h"
...
#endif  // MODULE_INPUT_IMAGEDECOMPRESSOR_H
