...
TEST_CASE("Test MotionModel Orientation", "[module][input][SensorFilter][MotionModel][orientation][matlab data]") {
...
TEST_CASE("Test MotionModel Orientation", "[module][input][SensorFilter][MotionModel][orientation][webots data]") {
    // Create our motion model
    UKF<double, MotionModel> filter{};
