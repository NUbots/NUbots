...
namespace module::input {
    ...
    public:
        ...
        utility::math::filter::KalmanFilter<float, n_states, n_inputs, n_measurements> kf{};
        ...
        void integrate_walkcommand(const float dt);
    ...
    private:
        ...
        std::array<Eigen::Isometry3f, 2> footlanding_Hwf{};
