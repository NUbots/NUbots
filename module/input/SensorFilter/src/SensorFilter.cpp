...
namespace module::input {
    ...
    void SensorFilter::debug_sensor_filter(std::unique_ptr<Sensors>& sensors, const RawSensors& raw_sensors) {
        ...
        emit(graph("rTWw est", est_rTWw.x(), est_rTWw.y(), est_rTWw.z()));
        ...
        if (raw_sensors.odometry_ground_truth.exists) {
            ...
            emit(graph("rTWw true", true_rTWw.x(), true_rTWw.y(), true_rTWw.z()));
            emit(graph("rTWw error", error_rTWw.x(), error_rTWw.y(), error_rTWw.z()));
