...
namespace input {
    ...
    void SpinnakerImageEvent::OnImageEvent(Spinnaker::ImagePtr image) {
        try {
            ...
            NUClear::log<NUClear::WARN>(ex.what());
            NUClear::log<NUClear::WARN>(ex.GetFullErrorMessage());
            NUClear::log<NUClear::WARN>(ex.GetFileName());
            NUClear::log<NUClear::WARN>(ex.GetFunctionName());
            NUClear::log<NUClear::WARN>(ex.GetBuildDate());
            NUClear::log<NUClear::WARN>(ex.GetBuildTime());
            NUClear::log<NUClear::WARN>(ex.GetLineNumber());
        }
    }
