    ...
    namespace input {
        ...
        class GameController : public NUClear::Reactor {
            private:
                ...
                void resetState();
                void process(const message::input::proto::GameState& oldGameState, const gamecontroller::GameControllerPacket& oldPacket, const gamecontroller::GameControllerPacket& newPacket);
                ...
                message::input::proto::GameState::Data::PenaltyReason getPenaltyReason(const gamecontroller::PenaltyState& penaltyState) const;
