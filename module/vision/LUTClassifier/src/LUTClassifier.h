...
namespace vision {
    ...
    private:
        ...
        unsigned int VISUAL_HORIZON_MINIMUM_SEGMENT_SIZE = 0;
        int VISUAL_HORIZON_SUBSAMPLING                   = 1;

        int GOAL_LINE_SPACING                                   = 100;
        int GOAL_SUBSAMPLING                                    = 1;
        unsigned int GOAL_RANSAC_MINIMUM_POINTS_FOR_CONSENSUS   = 10;
        unsigned int GOAL_RANSAC_MAXIMUM_ITERATIONS_PER_FITTING = 30;
        unsigned int GOAL_RANSAC_MAXIMUM_FITTED_MODELS          = 6;
        unsigned int GOAL_MINIMUM_RANSAC_SEGMENT_SIZE           = 1;
