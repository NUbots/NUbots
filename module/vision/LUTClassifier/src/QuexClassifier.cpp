...
namespace vision {
    ...
    std::vector<ClassifiedImage::Segment> QuexClassifier::classify(const Image& image,
        ...
        for (uint32_t typeID = lexer.receive(); typeID != QUEX_TKN_TERMINATION; typeID = lexer.receive()) {
            ...
            switch (typeID) {
                case QUEX_TKN_FIELD:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::FIELD,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                ...
                case QUEX_TKN_BALL:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::BALL,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                                                              convert<int, 2>(position),
                ...
                case QUEX_TKN_GOAL:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::GOAL,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                                                              convert<int, 2>(position),
                ...
                case QUEX_TKN_LINE:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::LINE,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                                                              convert<int, 2>(position),
                ...
                case QUEX_TKN_CYAN_TEAM:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::CYAN_TEAM,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                                                              convert<int, 2>(position),
                ...
                case QUEX_TKN_MAGENTA_TEAM:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::MAGENTA_TEAM,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                                                              convert<int, 2>(position),
                ...
                case QUEX_TKN_UNCLASSIFIED:
                    output.push_back(ClassifiedImage::Segment(SegmentClass::UNKNOWN_CLASS,
                                                              len,
                                                              subsample,
                                                              convert<int, 2>(s),
                                                              convert<int, 2>(position),
