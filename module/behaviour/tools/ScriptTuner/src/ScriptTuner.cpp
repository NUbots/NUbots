                    ...
                    for (auto& target : f.targets) {
                        ...
                        switch (target.id.value) {
                            ...
                            case ServoID::R_ELBOW:
                                newFrame.targets.push_back(
                                    {ServoID::L_ELBOW, target.position, target.gain, target.torque});
                                break;
                            case ServoID::L_ELBOW:
                                newFrame.targets.push_back(
                                    {ServoID::R_ELBOW, target.position, target.gain, target.torque});
                                break;
                            ...
                            case ServoID::R_KNEE:
                                newFrame.targets.push_back(
                                    {ServoID::L_KNEE, target.position, target.gain, target.torque});
                                break;
                            case ServoID::L_KNEE:
                                newFrame.targets.push_back(
                                    {ServoID::R_KNEE, target.position, target.gain, target.torque});
                                break;
