    ...
    namespace behaviour {
        namespace strategy {
                   ...
                   Single>()
                    .then([this](const Sensors& sensors,
                        ...
                        try {
                            ...
                            auto mode =
                                cfg_.forcePenaltyShootout ? GameMode::PENALTY_SHOOTOUT : gameState.data.mode.value;
            ...
            void SoccerStrategy::unpenalisedLocalisationReset(const FieldDescription& fieldDescription) {
                ...
                left.position     = Eigen::Vector2d(-fieldDescription.penalty_robot_start,
                ...
                right.position     = Eigen::Vector2d(-fieldDescription.penalty_robot_start,
                                                 -fieldDescription.dimensions.field_width * 0.5);
            ...
            void SoccerStrategy::goalieWalk(const Field& field, const Ball& ball) {
                ...
                float timeSinceBallSeen =
                    std::chrono::duration_cast<std::chrono::microseconds>(NUClear::clock::now() - ballLastMeasured)
                        .count()
                    * 1e-6;
