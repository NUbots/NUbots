...
#ifndef MODULE_BEHAVIOUR_STRATEGY_KEYBOARDWALKNEW_HPP
#define MODULE_BEHAVIOUR_STRATEGY_KEYBOARDWALKNEW_HPP
...
namespace module::behaviour::strategy {
    ...
    class KeyboardWalkNew : public NUClear::Reactor {
    private:
    ...
    public:
        /// @brief Called by the powerplant to build and setup the KeyboardWalkNew reactor.
        explicit KeyboardWalkNew(std::unique_ptr<NUClear::Environment> environment);
    };

}  // namespace module::behaviour::strategy


#endif  // MODULE_BEHAVIOUR_STRATEGY_KEYBOARDWALKNEW_HPP
