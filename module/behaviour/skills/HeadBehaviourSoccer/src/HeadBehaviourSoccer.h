...
namespace behaviour {
    namespace skills {
        ...
        private:
             ...
             */
            utility::math::geometry::Quad<arma::vec2> getScreenAngularBoundingBox(const message::vision::Balls& obs);
            utility::math::geometry::Quad<arma::vec2> getScreenAngularBoundingBox(const message::vision::Goals& obs);
