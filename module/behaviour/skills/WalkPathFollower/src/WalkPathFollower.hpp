    ...
    namespace behaviour {
        namespace skills {
            ...
            public:
                ...
                /// @brief The instantaneous walk command required to start moving to the next unvisited node on the
                /// path.
                std::unique_ptr<WalkCommand> walkToNextNode(const Eigen::Affine2d& currentState,
