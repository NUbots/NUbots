...
#ifndef MODULES_BEHAVIOUR_REFLEX_HEADBEHAVIOURSOCCEROLD_HPP
#define MODULES_BEHAVIOUR_REFLEX_HEADBEHAVIOURSOCCEROLD_HPP
...
namespace module::behaviour::skills {
     ...
     */
    class HeadBehaviourSoccerOld : public NUClear::Reactor {
    public:
    private:
        ...
        // CONFIG from HeadBehaviourSoccerOld.yaml
    ...
    public:
        explicit HeadBehaviourSoccerOld(std::unique_ptr<NUClear::Environment> environment);
    };

}  // namespace module::behaviour::skills

#endif  // MODULES_BEHAVIOURS_REFLEX_HEADBEHAVIOURSOCCEROld_HPP
