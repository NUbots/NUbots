...
namesapce modules {
    namespace vision {
        ...
        void Goal::setParameters(bool THROWOUT_SHORT_GOALS_, 
            ...
            FieldObjects::FO_YELLOW_GOALPOST_UNKNOWN
            FieldObjects::FO_YELLOW_LEFT_GOALPOST
            FieldObjects::FO_BLUE_LEFT_GOALPOST
            FieldObjects::FO_YELLOW_RIGHT_GOALPOST
            FieldObjects::FO_BLUE_RIGHT_GOALPOST
