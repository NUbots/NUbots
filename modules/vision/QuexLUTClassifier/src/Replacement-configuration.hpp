...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____REPLACEMENT
#define __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____REPLACEMENT
 ...
 *       or 'quex/code_base/configuration/derived' -- errors would be hard to find .*/ 
...
#   error "Asserts have been adapted before the inclusion of the configuration file."
#endif
#
...
#   define __QUEX_SETTING_INITIAL_LEXER_MODE_ID    (QUEX_NAME(ModeID_ReplacementRules))
#endif
...
#   define QUEX_FUNCTION_PREFIX        quex_Replacement_
#   define QUEX_FUNCTION_DEF_PREFIX    quex_Replacement_
    /* In 'C' there are no namespaces, so namespaces are coded directly
     * into the type name. Both, global and local names are equal.       */
#   define QUEX_TYPE0_ANALYZER         struct quex_Replacement_tag
#   define QUEX_TYPE_ANALYZER          struct quex_Replacement_tag
#   define QUEX_NAME_COMPLETE_ANALYZER quex_Replacement
#   define QUEX_TYPE_DERIVED_ANALYZER  struct quex_Replacement_tag
...
#   define QUEX_NAMESPACE_MAIN         quex_Replacement
...
#   define QUEX_NAME(NAME)             quex_Replacement_ ## NAME
...
#   define QUEX_FUNCTION_PREFIX_BACKUP       quex_Replacement_
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   quex_Replacement_
...
#   define QUEX_FUNCTION_PREFIX        ::quex::
     ...
     * and token.                                                        */
#   define QUEX_TYPE0_ANALYZER         Replacement
#   define QUEX_TYPE_ANALYZER          ::quex::Replacement
#   define QUEX_NAME_COMPLETE_ANALYZER ::quex::Replacement
#   define QUEX_TYPE_DERIVED_ANALYZER  Replacement
...
#   define QUEX_NAME(NAME)             Replacement_ ## NAME
#   define QUEX_NAME_TOKEN(NAME)       Token_ ## NAME
#   define QUEX_MEMBER(NAME)           Replacement::NAME                
    /* When creating a 'shared token class', macros are temporarily redefined.
     * This happens to generate converters in the token's namespace. After 
     * that, the original macros need to be restored. Thus: Backup!          */  
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____QUEX____REPLACEMENT */
