...
namespace modules {
    namespace vision {
        ...
        private:
            ...
            */
            void classifyHorizontalScan(const messages::input::Image& image, unsigned int y, const messages::vision::LookUpTable& LUT, messages::vision::SegmentedRegion* region);

            /*! @brief Returns a std::vector of ColourSegments detailing the
            vertical colour segments in the image.
            */
            void classifyVerticalScan(const messages::input::Image& image, const arma::vec2& start, const messages::vision::LookUpTable& LUT, messages::vision::SegmentedRegion* region);
