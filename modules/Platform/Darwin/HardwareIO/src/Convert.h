...
namespace Darwin {
    struct Convert {
        ...
        static const int8_t SERVO_DIRECTION[20];

        /// Offsets the radian angles of motors to change their 0 position
        static const float SERVO_OFFSET[20];
         ...
         */
        static double SPEED_CONVERSION_FACTOR[20];
    ...
    /// Picks which direction a motor should be measured in (forward or reverse)
    const int8_t Convert::SERVO_DIRECTION[20] = {
    ...
    /// Offsets the radian angles of motors to change their 0 position
    const float Convert::SERVO_OFFSET[20] = {
