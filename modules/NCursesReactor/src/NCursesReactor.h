...
#ifndef MODULES_NCURSESREACTOR_H
#define MODULES_NCURSESREACTOR_H

#include <NUClear.h>

namespace modules {

    class NCursesReactor : public NUClear::Reactor {
    private:
        void run();
        void kill();
    public:
        explicit NCursesReactor(NUClear::PowerPlant* plant);
    };
}
#endif
