...
#
# LIBGFORTRAN_FOUND - system has libGFortran LIBGFORTRAN_LIBRARIES - Link these
# to use libGFortran
#
...
if(LIBGFORTRAN_LIBRARIES)
  ...
  # Try to use gfortran to output its path to search Query gfortran to get the
  # libgfortran.so path
  ...
  if(GFORTRAN_LIBRARY AND QUADMATH_LIBRARY)
    set(LIBGFORTRAN_LIBRARIES ${LIBGFORTRAN_LIBRARIES} ${GFORTRAN_LIBRARY}
                              ${QUADMATH_LIBRARY})
  endif(GFORTRAN_LIBRARY AND QUADMATH_LIBRARY)

  include(FindPackageHandleStandardArgs)
  find_package_handle_standard_args(LIBGFORTRAN DEFAULT_MSG GFORTRAN_LIBRARY
                                    QUADMATH_LIBRARY)

  # show the LIBGFORTRAN_LIBRARIES variables only in the advanced view
  mark_as_advanced(LIBGFORTRAN_LIBRARIES GFORTRAN_LIBRARY QUADMATH_LIBRARY
                   _GFORTRAN_EXECUTABLE)
