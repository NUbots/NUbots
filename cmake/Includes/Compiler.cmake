...
SET(CMAKE_CXX_FLAGS_RELEASE        "-fuse-linker-plugin -flto -fno-fat-lto-objects ${CMAKE_CXX_FLAGS_RELEASE} ${COMMON_CXX_FLAGS}")
SET(CMAKE_C_FLAGS_RELEASE          "-fuse-linker-plugin -flto -fno-fat-lto-objects ${CMAKE_C_FLAGS_RELEASE} ${COMMON_C_FLAGS}")
