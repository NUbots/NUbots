...
export class KinematicsNetwork {
  constructor(private network: Network, private model: KinematicsModel) {
    this.network.on(Sensors, this.onSensors)
  }

  static of(nusightNetwork: NUsightNetwork, model: KinematicsModel): KinematicsNetwork {
    const network = Network.of(nusightNetwork)
    return new KinematicsNetwork(network, model)
  }
