...
function createModel(animate?: 'animate') {
  ...
  const model = KinematicsRobotModel.of(robotModel)
...
storiesOf('component.kinematics.darwin_robot', module)
...
function simulateWalk(model: KinematicsRobotModel, t: number) {
