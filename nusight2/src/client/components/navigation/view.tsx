...
const NavigationItemView = ({ url, Icon, children }: NavigationItemViewProps) => (
  <li className="whitespace-nowrap">
    <NavLink
      className={({ isActive }) => {
        return `p-4 flex flex-col items-center text-primary-auto text-xs hover:bg-auto-contrast-1 ${isActive ? "!bg-nusight-500" : ""
          }`;
      }}
      to={url}
    >
...
export const NavigationView = ({ nav }: { nav: NavigationConfiguration }) => (
  <div className="bg-[#474747ff] text-white text-center flex flex-col justify-between items-center dark">
    <header>
