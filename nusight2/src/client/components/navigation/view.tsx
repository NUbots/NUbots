...
const NavigationItemView = ({ url, Icon, children }: NavigationItemViewProps) => (
  <li className="whitespace-nowrap">
    <NavLink
      className={({ isActive }) => {
        return `p-4 flex flex-col items-center text-xs hover:bg-auto-contrast-1 text-white ${isActive ? "!bg-nusight-600" : ""
          }`;
      }}
      to={url}
    >
...
export const NavigationView = ({ nav }: { nav: NavigationConfiguration }) => (
  <div className="dark bg-gray-800 dark:bg-auto-surface-1 border-r border-auto text-center flex flex-col justify-between items-center">
    <header>
