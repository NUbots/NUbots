...
const NavigationItemView = ({ url, Icon, children }: NavigationItemViewProps) => (
  <li className="whitespace-nowrap">
    <NavLink
      className={({ isActive }) => {
        return `p-4 flex flex-col items-center text-primary-auto text-xs hover:bg-contrast-2 ${isActive ? "!bg-nusight-500" : ""
          }`;
      }}
      to={url}
    >
...
export const NavigationView = ({ nav }: { nav: NavigationConfiguration }) => (
  <div className="bg-gray-750 text-white text-center flex flex-col justify-between items-center dark">
    <header>
