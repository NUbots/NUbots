...
> {
  ...
  render() {
    ...
    return (
      <>
        <div className="bg-gray-300 dark:bg-gray-800 shadow shadow-md py-2 px-3">
          <label className="pr-4 shrink-0">
            Minimum Value
            <input
              className="bg-gray-150 dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-300 shadow-inner focus:outline-none focus:outline-gray-400 dark:focus:outline-gray-600 px-2 py-1 rounded-sm ml-2 w-24"
              type="number"
