...
export const GoalLabels: React.FC<GoalLabelsProps> = observer(({
    fieldModel,
    teamColour,
    cameraPitch,
    cameraYaw,
    ...
    // In this field coordinate system:
    // - Our own goal is always at positive x (yellow goal)
    // - Opponent goal is always at negative x (blue goal)
    // This is consistent regardless of team color
    const blueGoalLabel = "OPP";    // Blue goal at negative x
    const yellowGoalLabel = "OWN";  // Yellow goal at positive x
