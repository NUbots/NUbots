...
export function IconZoomIn(props: { className?: string }) {
  return (
    <svg className={props.className} viewBox="0 0 24 24" stroke="#F9A50D" xmlns="http://www.w3.org/2000/svg">
...
export function IconZoomReset(props: { className?: string }) {
  return (
    <svg className={props.className} viewBox="0 0 24 24" fill="#F9A50D" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
