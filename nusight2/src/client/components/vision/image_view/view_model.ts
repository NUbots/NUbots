...
export class ImageViewModel {
  ...
  private readonly imageTexture = imageTexture(({ image, width, height, format }: ElementOrBitmapImage) => ({
    image,
    width,
    height,
  ...
  private readonly dataTexture = dataTexture(({ image: data, width, height, format }: DataImage) => ({
    data: data.get(),
    width,
    height,
    format: this.textureFormat(format),
